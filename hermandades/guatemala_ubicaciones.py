# Datos territoriales de Guatemala para formularios dependientes.

MUNICIPIOS_POR_DEPARTAMENTO = {'Alta Verapaz': ['Cobán',
                  'Chahal',
                  'Chisec',
...
DEPARTAMENTO_CHOICES = [
    ...
    for departamento in MUNICIPIOS_POR_DEPARTAMENTO
]
